...
class CallbackFlow {
    public static macro function compute<T>(blockExpr: Expr): ExprOf<hxgnd.Promise<T>> {
    ...
    public static macro function computeNodeJsStyle<T>(blockExpr: Expr): ExprOf<hxgnd.Promise<T>> {
        var expr = Computation.perform(
            {
